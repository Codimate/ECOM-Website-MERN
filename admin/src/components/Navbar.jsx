...
const Navbar = () => {
  return (
      ...
      <nav className='max_padd_container flexBetween bg-white py-2 ring-1  ring-slate-900/5 relative'>
        ...
        <div className='uppercase bold-22 text-white bg-cyan-500 px-3 rounded-md tracking-wides line-clamp-1 
                        max-xs:bold-18 max-xs:py-2 max-xs:px-1'>Admin Panel</div>
