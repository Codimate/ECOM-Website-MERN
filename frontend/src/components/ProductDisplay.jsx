    ...
    <section>
      <div className="flex flex-col gap-14 xl:flex-row">
        ...
        <div className="flex-col flex xl:flex-[1.7]">
          ...
          <div className="flex gap-x-2 text-cyan-500 medium-22">
            <MdStar />
            <MdStar />
            <MdStar />
            <MdStar />
          ...
          <div className="flex gap-x-6 medium-20 my-4">
            ...
            <div className=" text-cyan-500">{product.new_price}</div>
          </div>
          <div className="mb-14">
            ...
            <p>
              <span className="medium-16 text-cyan-500">Category : </span> Women
              | Jacket | Winter
            </p>
            <p>
              <span className="medium-16 text-cyan-500">Tags : </span> Modern |
              Latest
            </p>
          </div>
        </div>
